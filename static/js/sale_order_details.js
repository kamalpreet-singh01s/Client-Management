...
function hideDisable() {
    ...
    let hide_table3 = document.getElementById('hide_table3');
    ...
    let hide_table2 = document.getElementById('hide_table2');
...
$('#file1-upload').change(function () {
    let i = $(this).prev('label').clone();
    let file = $('#file1-upload')[0].files[0].name;
    $(this).prev('label').text(file);
});
...
gst_select.onchange = function () {
    let gst_no = gst_select.value;
    let final_deal_amount_gst;
...
let adjust_credit_textbox = document.getElementById("adjust_credit_textbox")
...
let credit_add_button = document.getElementById("credit_add_button")
